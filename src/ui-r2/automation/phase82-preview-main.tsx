...
const manualRule: AutomationRule = Object.freeze({
  ...
  actions: Object.freeze([{ type: 'create_followup' as const, title: 'متابعة التأخير', dueInDays: 1 }]),
...
const eventRule: AutomationRule = Object.freeze({
  ...
  conditions: Object.freeze([{ field: 'priority', operator: 'eq' as const, value: 'high' }]),
  actions: Object.freeze([{ type: 'workflow_transition' as const, instanceIdField: 'workflowInstanceId', expectedStageField: 'stagePosition', transitionKey: 'approve_review', reason: 'مراجعة بشرية' }]),

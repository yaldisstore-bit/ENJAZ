...
const CalendarPortal = lazy(() => import('../scheduling/LiveSchedulingCalendarPortal.tsx').then((module) => ({ default: module.LiveSchedulingCalendarPortal })));
...
export function LazyLiveProductionPortals({ regulatoryKnowledge, regulatoryWorkspace, documentVaultFactory, documentIntelligenceFactory, documentFactoryFactory, engagementContractFactory, documentWorkspace }: Props) {
  ...
  return <Suspense fallback={null}>
    {destination === 'today.notifications' ? <NotificationsPortal />
      : destination === 'calendar' ? <CalendarPortal />

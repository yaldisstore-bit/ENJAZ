...
createRoot(root).render(<StrictMode><div className="ez-r2-root r2-shell" data-r2-runtime-mode="live" data-destination="copilot"><main id="r2-main" className="r2-shell__main" aria-label="مساعد إنجاز"><section data-live-deferred="true">placeholder</section></main><LiveCopilotPortal workspace={Promise.resolve(W)} invoke={invoke}/></div></StrictMode>);

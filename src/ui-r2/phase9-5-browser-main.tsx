...
import { ENJAZ_BI_SCHEMA,type BIProvenance } from '../features/intelligence/businessIntelligenceContract.ts';
...
const snapshot:BusinessIntelligenceSnapshot=Object.freeze({
 schema:ENJAZ_BI_SCHEMA,workspaceId:W,generatedAt:AS_OF,authority:'read_only_derived_intelligence',
 kpis:Object.freeze([

...
export function LiveFinanceProductionPortal() {
  ...
  return createPortal(<div className="r2-finance-phase74-stack"><ConnectedPhase74FinancialReportsExperience /><ConnectedPhase73FinancialIntelligenceExperience /><ConnectedPhase72FinanceExperience /></div>, target);
}

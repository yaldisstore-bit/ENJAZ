...
function Hero(){return <div className="r2-section-heading r2-section-heading--hero"><div><p className="r2-eyebrow">M13 · Business Intelligence · Phase 9.5</p><h1>مركز ذكاء الأعمال</h1><p>مؤشرات وتنبؤات اتجاهية مشتقة من حقائق إنجاز المعتمدة، مع توثيق المصدر والعينات. هذه الشاشة لا تكتب في مصادر البيانات ولا تعرض التنبؤ كحقيقة مستقبلية.</p></div></div>}

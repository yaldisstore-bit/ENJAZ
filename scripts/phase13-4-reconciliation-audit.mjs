...
req(
  ...
  roadmap.includes('## 13.5 — Import Destruction Gate ✅ CLOSED /'),
  'roadmap must preserve Phase 13.5 authorized-next history, active successor, governed closure candidate or certified formal closure'
);

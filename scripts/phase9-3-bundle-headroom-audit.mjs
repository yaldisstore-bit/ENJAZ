...
for(const marker of ["const named=","named(()=>import('../records/LiveCompaniesProductionPortal.tsx')","named(()=>import('../records/LivePeopleProductionPortal.tsx')","named(()=>import('../finance/LiveFinanceProductionPortal.tsx')",'MutationObserver'])if(!lazy.includes(marker))fail(`lazy portal contract missing ${marker}`);

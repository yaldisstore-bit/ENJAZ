...
const scenarios = [
  ...
  { name: 'remove app shell dynamic viewport', file: 'src/styles/app-shell.css', mutate: (value) => value.replaceAll('100dvh', '100vh') },
  { name: 'remove bottom safe area', file: 'src/styles/app-shell.css', mutate: (value) => value.replaceAll('safe-area-inset-bottom', 'safe-area-bottom-removed') },

...
for (const required of [statePath, parityPath, iaPath]) {
...
for (const target of Object.values(ia.searchContract?.aliases ?? {})) {
...
if (errors.length) {
  ...
  console.log(`ENJAZ R2.0 INFORMATION ARCHITECTURE AUDIT PASS — ${parity.capabilities.length} capabilities, five doors, zero hidden primary navigation, canonical homes resolved.`);
}

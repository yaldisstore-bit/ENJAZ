...
const mutations = [
  ...
  ['remove hero composition', (s) => ({ ...s, component: s.component.replace('rebirth-home__hero', 'rebirth-home__flat') })],
  ['remove hero score', (s) => ({ ...s, component: s.component.replace('rebirth-home__hero-score', 'rebirth-home__score-gone') })],
  ['remove compact stats capsule', (s) => ({ ...s, component: s.component.replace('rebirth-home__hero-stats', 'rebirth-home__stats-gone') })],
  ['remove priority mosaic', (s) => ({ ...s, component: s.component.replace('rebirth-home__priority-mosaic', 'rebirth-home__priority-list') })],
  ['remove finance module', (s) => ({ ...s, component: s.component.replace('rebirth-home__finance', 'rebirth-home__money') })],
  ['remove operational signal stack', (s) => ({ ...s, component: s.component.replace('rebirth-home__signal-stack', 'rebirth-home__signals-gone') })],
  ['remove closing action composition', (s) => ({ ...s, component: s.component.replace('rebirth-home__closing', 'rebirth-home__closing-gone') })],

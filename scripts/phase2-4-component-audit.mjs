...
function phaseAtLeast(value, major, minor) {
  ...
  const parsedMajor = Number(value[1]);
  const parsedMinor = Number(value[2]);
...
check('GitHub gate covers phase 2.4 or later', phaseAtLeast(workflowCommandPhase, 2, 4) && phaseAtLeast(workflowLabelPhase, 2, 4));

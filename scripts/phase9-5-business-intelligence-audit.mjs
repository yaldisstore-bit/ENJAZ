...
const tests=read('tests/phase9-5-business-intelligence-foundation.test.ts');
...
req(p95.phase==='9.5'&&p95.status==='IN_PROGRESS','Phase 9.5 must remain IN_PROGRESS during foundation');
...
else console.log('PHASE 9.5 BUSINESS INTELLIGENCE AUDIT PASS — predecessor closure preserved; M13 active/open; provenance, exact money, workspace isolation, additive-only directional forecast semantics and Phase 9.6 lock enforced.');

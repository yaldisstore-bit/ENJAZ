...
if(exists('docs/PHASE13_3_STATE.json')){
  ...
  req(['A1_DETERMINISTIC_ORDERED_IMPORT_PLAN','A2_EXPLICIT_TARGET_ID_IDEMPOTENCY_BINDING','A3_SERVER_EXECUTION_BOUNDARY'].includes(p133.currentSlice)&&p133.orderedImportPlanningAllowed===true&&p133.orderedImportExecutionAllowed===false,'Phase 13.3 pre-execution planning law drifted');

...
if(exists('docs/PHASE13_2_STATE.json')){
  ...
  req(p132.currentSlice==='A3_DESTRUCTION_AND_CLOSURE_READINESS'&&p132.a1Status==='CERTIFIED'&&p132.a2Status==='CERTIFIED'&&p132.a3Status==='IN_PROGRESS','Phase 13.2 A1/A2/A3 lifecycle drifted');

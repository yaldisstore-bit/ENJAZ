...
for (const marker of ['useOptionalDataLayerFactory','<ConnectedCompanies />','عرض فقط في R2.0-6','لا تنفّذ إنشاءً أو تعديلًا أو رفع ملفات إنتاجية','data-records-domain="people"','data-records-domain="documents"']) requireMarker(records, marker, 'records compatibility');

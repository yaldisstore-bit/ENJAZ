...
- **Phase 12.3 — Agentic ENJAZ Copilot — M9: 🟡 IN_PROGRESS — A1/A2/A3-A/A3-B certified; only `followup.snooze` and `followup.create` are executable under explicit approval; all other mutations remain locked.**

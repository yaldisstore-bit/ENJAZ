...
الحالة الرسمية: **Phase 13.2 — Normalize & Map 🟡 IN PROGRESS — A2 EXPLICIT RELATIONSHIP PREVIEW**  
آخر مرحلة مغلقة: **Phase 13.1 — Read-only Legacy Snapshot Intake ✅ CLOSED / PR + EXACT-MAIN + DEPLOYED-LIVE CERTIFIED**  
المرحلة الحالية: **Phase 13.2 — Normalize & Map — A2 IN PROGRESS؛ Phase 13.3 LOCKED**.
...
- **Phase 13.2 — Normalize & Map: 🟡 IN PROGRESS — A1 explicit type/field mapping CERTIFIED؛ A2 explicit relationship preview in progress; no FK/ID assignment, persistence, writes or ordered import; 13.3 LOCKED.**
...
- current slice: **A2 — EXPLICIT RELATIONSHIP PREVIEW**.
- A1: **CERTIFIED** — Gate #2 / `35398804690`؛ 12/12 tests + 219/219 functional + 25/25 DB self-test; budgets 431032 / 759568 / 179989.
- A2: exact relationship declaration only; FK assignment and ID generation remain forbidden.

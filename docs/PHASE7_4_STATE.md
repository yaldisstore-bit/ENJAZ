...
- company/transaction scopes fail closed on cashbox opening balances: unattributable cashbox balances are excluded instead of being inherited from the workspace;
